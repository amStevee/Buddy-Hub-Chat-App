...
document.getElementById('header-avatar').innerHTML = BuddyAvatar.render('SM', null, 40, true);
...
function renderMessages() {
  messageList.innerHTML = messages.map((m) => BuddyMessageBubble.render(m.text, m.time, m.outgoing)).join('');
